...
% Alternative fonts to try (uncomment one at a time):
% All of these are available in TeX Live and will work on GitHub Actions

% \setmainfont{TeX Gyre Pagella}      % Palatino clone - elegant, similar to Bembo
% \setmainfont{TeX Gyre Termes}       % Times clone - classic, compact
% \setmainfont{TeX Gyre Schola}       % Century Schoolbook - readable, traditional
% \setmainfont{TeX Gyre Bonum}        % Bookman - slightly wider, friendly
% \setmainfont{Libertinus Serif}      % Linux Libertine - elegant, academic
% \setmainfont{EB Garamond}           % Garamond - classical, refined
% \setmainfont{Crimson Pro}           % Modern take on Garamond - clean
\setmainfont{STIXGeneral}           % STIX - scientific/academic font - professional
% \setmainfont{STIX Two Text}         % Scientific/academic font - professional
...
\cventry{2012--2015}{NIHR ACF in Dementia / ST in Old Age Psychiatry}{Cambridge University and Cambridge \& Peterborough Foundation Trust}{Cambridge}{}{Academic Supervisor: Prof. John O'Brien}
...
\cventry{2024--Present}{Honorary Consultant, Parkinson's Neuropsychiatry}{Manchester University NHS Foundation Trust}{}{}{Monthly joint neuropsychiatry clinic with geriatric medicine colleagues (delivered pro bono).}
...
\cvline{}{Faculty member for the Neurology Academy, Sheffield (2017--2020). Teaching on Parkinson's Disease neuropsychiatry, Palliative and Dementia Masterclasses, and Mild Cognitive Impairment/Brain Health webinar series. Registered trainer and educational supervisor of higher trainees in old age psychiatry.}
...
\section{Industry Collaboration \& Implementation Projects}
\cvline{}{Industry-partnered, system-level evaluation and implementation work supporting NHS readiness for molecular diagnostics and disease-modifying therapies in dementia. Delivered as service evaluation and readiness projects rather than published research, with income contracted to the Trust.}
\cventry{2026--2028}{System-readiness mapping for disease-modifying therapies in Alzheimer's disease}{Lilly}{£50,000}{Co-Investigator}{NHS system-readiness assessment for DMT rollout, building on the multi-site CSF feasibility programme.}
\cventry{2023--2025}{NHS CSF biomarker service feasibility and development}{DPUK / Lilly}{£85,000}{Co-Investigator}{Four-site evaluation across two mental health and two neurology memory clinics, informing national replication of in-house NHS CSF diagnostics.}
...
\cventry{2025--2028}{Dementia Trials Network Manchester Site}{MRC/DRI}{£265,431}{PI}{}
...
\cventry{2025}{Health Services Journal Award}{}{}{}{Best NHS Collaboration}
\cventry{2025}{Health Services Journal Partnerships Award}{}{}{}{Best Pharmaceutical Collaboration with the NHS (DPUK-led multisite evaluation project with Lilly, GMMH and NHS trusts in Sheffield, Oxford, Sussex)}
...
\cventry{2026}{Building consensus on the design, delivery and growth of UK brain health clinics}{ICOPAD 2026}{Geneva}{}{}
\cventry{2026}{Brain Health Clinics -- The Manchester Model}{5th APAA}{Abu Dhabi}{}{}
\cventry{2025}{Variation in vascular risk assessment and management across UK and Irish memory/brain health clinics: a cross-sectional survey}{VasCog 2025}{Exeter}{}{}
\cventry{2025}{Repurposed Drug Prioritisation Pipeline for an Alzheimer's Disease Multi-arm Platform Trial}{Alzheimer's Association International Conference}{USA}{}{}
...
\cventry{2025}{Cases in Dementia Diagnosis}{Dementias UK Conference}{London}{}{}
\cventry{2024}{Building molecular diagnostics in NHS Mental Health Trusts}{NHSE Northwest Dementia SIG}{Online}{}{}
\cventry{2024}{brainHealth Manchester, roadmap toward DMTs for GM}{British Geriatrics Society NW division}{Online}{}{}
\cventry{2024}{Dementia Research Update}{RCPsych Northwest Dementia Symposium}{Online}{}{}
\cventry{2024}{Titanic problems in machine learning}{ARUK Research Conference}{London}{}{}
\cventry{2024}{Getting up and walking with CSF biomarkers in UK MH trusts}{London Memory Clinic Network}{Online}{}{}
\cventry{2024}{Neuropsychiatry of Parkinson's update}{Parkinson's UK}{London}{}{}
\cventry{2024}{Clinical Cases}{Dementias Conference 2024}{London}{}{}
\cventry{2023}{Building a Brain Health Clinic}{Old Age Psychiatry Faculty RCPsych Webinar}{Online}{}{}
\cventry{2023}{Brain Health Clinics}{RCPsych Old Age Psychiatry Conference}{Liverpool}{}{}
\cventry{2023}{Cases panel chair}{Dementias Conference 2023}{London}{}{}
\cventry{2022}{Cognitive Assessment in Context: Education, Language and Culture}{ARUK Clinical Conference}{London}{}{}
\cventry{2022}{Motivational Interviewing for Brain Health}{Brain Health 2022}{Edinburgh}{}{}
\cventry{2022}{Brain Health Manchester - Pathway and Progress}{Oxford Brain Health Symposium}{Oxford}{}{}
\cventry{2021}{Effect of baseline systolic hypertension on cognitive decline in Alzheimer's disease}{ARUK Research Conference}{}{}{}
...
\cvline{Parkinson's Neuropsychiatry Clinic}{Established and lead a monthly joint Parkinson's neuropsychiatry clinic with geriatric medicine colleagues at Manchester University NHS Foundation Trust (since November 2024), addressing the unmet need for specialist management of neuropsychiatric symptoms in Parkinson's disease. Delivered on a voluntary basis (out of job plan) under an honorary MFT contract, the service integrates mental health and neurology/geriatric medicine across trust boundaries.}
...
\cvline{Qualifications}{PgDipStat from TCD (2010). Google accredited certificate in IT automation with Python. Completed 4-day "Regression Modelling Strategies" course with Prof. Frank Harrell at Vanderbilt (2022/3). Attended ONS ``Safe Researcher Training'' 2021.}
...
\cvline{fastmlm}{R package for fast estimation of linear and generalised linear mixed-effects models, 4--14$\times$ faster than lme4 via a high-performance C++ backend (custom formula parser, C++ L-BFGS-B optimiser, CHOLMOD supernodal sparse Cholesky, optional CUDA GPU acceleration). Drop-in lmer()/glmer() syntax with numerically identical results, Satterthwaite degrees of freedom, and emmeans/broom.mixed integration: \url{https://github.com/sadneurons/fastmlm}}
...
\cvline{maxima-quarto-extension}{A Quarto extension enabling the "Maxima" symbolic mathematical engine: \url{https://github.com/sadneurons/maxima-quarto-extension}}
...
\cvline{Grant Review}{Grant review board co-chair for Alzheimer's Society UK (2022--26), chairing and co-chairing expert review panels on physiology, biomarkers and clinical research. Grant review board member for Alzheimer's Research UK (2023--26) and The Alzheimer Society Ireland (2023).}
